...
import 'package:openpocket/models/stt_response_schema.dart';
...
class SttProviderConfig {
  ...
  static final _configs = <SttProvider, SttProviderConfig>{
    ...
    SttProvider.onDeviceLeap: SttProviderConfig(
      provider: SttProvider.onDeviceLeap,
      displayName: 'On-Device LEAP',
      description: 'LEAP SDK on-device transcription & summarization (Offline, iOS)',
      icon: FontAwesomeIcons.bolt,
      requestType: SttRequestType.multipartForm,
  ...
  Map<String, dynamic> buildRequestConfig({
    ...
    switch (provider) {
      ...
      case SttProvider.onDeviceLeap:
        // LEAP uses platform channel, no HTTP config needed
        config['url'] = '';
        config['params'] = {'language': lang};
        break;
