...
import 'package:openpocket/backend/schema/message_event.dart';
import 'package:openpocket/backend/schema/transcript_segment.dart';
import 'package:openpocket/env/env.dart';
import 'package:openpocket/models/custom_stt_config.dart';
import 'package:openpocket/models/stt_provider.dart';
import 'package:openpocket/services/notifications.dart';
import 'package:openpocket/services/sockets/on_device_apple_provider.dart';
import 'package:openpocket/services/sockets/on_device_leap_provider.dart';
import 'package:openpocket/services/sockets/on_device_whisper_provider.dart';
import 'package:openpocket/services/sockets/pure_socket.dart';
import 'package:openpocket/services/sockets/transcription_service.dart';
import 'package:openpocket/utils/debug_log_manager.dart';
import 'package:openpocket/utils/logger.dart';

export 'package:openpocket/utils/audio/audio_transcoder.dart';
export 'package:openpocket/services/sockets/composite_transcription_socket.dart';
export 'package:openpocket/services/sockets/pure_polling.dart';
export 'package:openpocket/services/sockets/pure_streaming_stt.dart';
export 'package:openpocket/models/stt_response_schema.dart';
export 'package:openpocket/models/stt_result.dart';
export 'package:openpocket/services/sockets/transcription_polling_service.dart';
...
class TranscriptSocketServiceFactory {
  ...
  static IPureSocket _createPollingSocket(
    ...
    // Special handling for On-Device LEAP (iOS only)
    if (config.provider == SttProvider.onDeviceLeap) {
      return PurePollingSocket(
        ...
        sttProvider: OnDeviceLeapProvider(
