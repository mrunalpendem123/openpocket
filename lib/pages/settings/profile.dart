...
import 'package:openpocket/pages/settings/change_name_widget.dart';
import 'package:openpocket/pages/settings/language_settings_page.dart';
import 'package:openpocket/pages/settings/custom_vocabulary_page.dart';
import 'package:openpocket/pages/settings/people.dart';
...
import 'package:openpocket/pages/settings/conversation_display_settings.dart';
            ...
            _buildSectionContainer(
              children: [
                _buildProfileItem(
                  title: 'Storage Used',
                  chipValue:
                      '${LocalStorageService.instance.totalConversations} conversations, ${LocalStorageService.instance.totalMemories} memories',
                ...
                _buildProfileItem(
                  ...
                  icon: const FaIcon(FontAwesomeIcons.trash, color: Colors.red, size: 20),
                  onTap: () async {
                    final confirmed = await showDialog<bool>(
                      ...
                      builder: (ctx) => AlertDialog(
                        ...
                        content: const Text(
                          'This will permanently delete all conversations, memories, and settings stored locally. This action cannot be undone.',
