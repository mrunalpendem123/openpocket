...
import 'package:openpocket/pages/settings/notifications_settings_page.dart';
import 'package:openpocket/pages/settings/profile.dart';
...
import 'package:openpocket/backend/http/api/announcements.dart';
import 'package:openpocket/pages/announcements/changelog_sheet.dart';
...
class _SettingsDrawerState extends State<SettingsDrawer> {
  ...
  Future<void> _copyVersionInfo() async {
    final versionPart = buildVersion != null ? 'OpenPocket ${version ?? ""} ($buildVersion)' : 'OpenPocket ${version ?? ""}';
