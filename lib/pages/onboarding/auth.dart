...
import 'package:openpocket/widgets/consent_bottom_sheet.dart';
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            ConsentBottomSheet.show(
                              ...
                              authMethod: 'apple',
                              onContinue: () async {
                                final user = AuthService.instance.getFirebaseUser();
                                if (user != null && SharedPreferencesUtil().hasPersonaCreated) {
