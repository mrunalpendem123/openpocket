...
import 'package:openpocket/pages/onboarding/wrapper.dart';
import 'package:openpocket/pages/persona/persona_provider.dart';
import 'package:openpocket/pages/persona/twitter/verify_identity_screen.dart';
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            if (_formKey.currentState!.validate()) {
                              ...
                              // Auth check removed — offline mode
                        ...
                        true // Auth check removed — offline mode
                            ? TextButton(
                                onPressed: () async {
                                  FocusScope.of(context).unfocus();
