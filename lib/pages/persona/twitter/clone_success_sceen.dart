...
import 'package:openpocket/pages/chat/clone_chat_page.dart';
import 'package:openpocket/pages/persona/persona_provider.dart';
import 'package:openpocket/utils/other/string_utils.dart';
...
class _CloneSuccessScreenState extends State<CloneSuccessScreen> {
  void _handleNavigation() async {
    // Auth gating removed — always go to profile
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      false // Auth removed — offline mode
                    ...
                    widget.message.isNotEmpty
                        ...
                        : const SizedBox(),
                    const Spacer(flex: 2),
                    if (true) // Auth removed — offline mode
                      Padding(
