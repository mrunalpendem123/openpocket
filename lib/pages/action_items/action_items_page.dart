...
import 'package:openpocket/backend/http/api/goals.dart';
...
export 'package:openpocket/backend/http/api/goals.dart' show Goal;
    ...
    showModalBottomSheet(
      ...
      builder: (sheetContext) => _GoalCreateSheet(
        onSave: (title, current, target) async {
          ...
          if (created != null) {
            MixpanelManager()
                .goalCreated(goalId: created.id, titleLength: 0, targetValue: 0, source: 'tasks_page');
          }
        },
      ),
    );
